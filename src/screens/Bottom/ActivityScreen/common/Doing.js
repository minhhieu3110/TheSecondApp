      ...
      <Block width={width - 24} marginTop={15} marginHorizontal={12}>
        ...
        <Block
          ...
          <Block marginTop={18} marginLeft={12}>
            <Text fontSize={17} semiBold color={COLORS.green5}>
          ...
          <Block
            ...
            top={12}
            right={12}>
            <Text fontSize={13} regular color={COLORS.green5}>
              Đang làm
            </Text>
          </Block>
          <Block
            ...
            <Block marginLeft={23} row marginBottom={12}>
              ...
              <Text marginLeft={8} fontSize={14} regular color={COLORS.black1}>
                Thứ 7, 25/02/2025
              </Text>
            </Block>
            <Block marginLeft={23} row marginBottom={12}>
            ...
            <Block marginLeft={23} row marginBottom={12}>
              <Image source={icon.icon_price_service} width={22} height={22} />
