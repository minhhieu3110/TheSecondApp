...
export default function Sicker_Servicedurationmonth() {
  const dayWeek = [
    {id: 1, title: 'T2'},
    {id: 2, title: 'T3'},
    {id: 3, title: 'T4'},
  ...
  return (
    <Block flex backgroundColor={COLORS.gray10}>
      ...
      <ButtonSubmitService
        ...
        titleBottom={'Dịch vụ chăm người bệnh tại nhà'}
        onPress={() => commonRoot.navigate(router.SICKER_CONFIRM_PAY_MONTH)}
      />
